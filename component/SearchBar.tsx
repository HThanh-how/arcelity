...
import { Box, Flex, Input, Button, Stack, useColorModeValue, VStack, Menu, MenuButton, MenuList, MenuItem, Icon, useDisclosure } from '@chakra-ui/react';
...
const SearchBar = () => {
  ...
  return (
    ...
    </Flex><Flex h={16} alignItems={'center'} justifyContent={'space-between'} display={{ base: "flex", md: "none" }}>
        <Icon m={4} as={SearchIcon} onClick={()=>openSearch(true)} display={search?"none":"flex"} transition={'all .25s ease-in-out'}/>
    <Input 
          m={4}
